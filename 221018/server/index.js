...
// 안넣으면 텍스트(즉 string) 방식으로 된다.

app.use(express.urlencoded({ extended: false }));
// querystring을 파싱할 때 사용하는 방법을 설정
// 모듈을 사용하지 않겠다. 라는 뜻 << extended:false
...
// 쿠키란?
// 사용자의 정보를 임시 저장한다. << 인터넷 사이트에 종종 쿠키 허락하겠냐 라는 창이 뜨는데, 허락을 구하는 이유
// 원래의 쿠키는 뭐냐 --> 데이터를 임시 저장한 공간
// 데이터란 간단한 텍스트 << 이미지, 영상 등등은 포함하지 않는다.
// 쿠키 VS 캐시
// cache 캐시 << 이미지, 영상, 텍스트 등을 파일로 임시 저장하는 공간

// 세션이란?
// 쿠키랑 같은 기능을 한다. << 텍스트를 임시로 저장한다.
// 쿠키랑 차이점 -- 쿠키는 로컬(내 컴퓨터)에 저장 / 브라우저에서 관리함
